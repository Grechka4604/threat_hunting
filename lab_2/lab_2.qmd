...
В ходе выполнения практической работы были отработаны навыки использования языка R для анализа и обработки табличных данных, а также изучены особенности набора данных starwars.

### Вывод

В результате работы мы закрепили применение базовых функций пакета dplyr для обработки данных: select(), filter(), mutate(), arrange(), group_by(), и научились использовать их на реальном примере.